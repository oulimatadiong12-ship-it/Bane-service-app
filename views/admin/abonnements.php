    ...
    <table border="1" cellpadding="5">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Renouveler -->
                    <form method="post" action="../../controllers/AbonnementController.php" style="display:inline">
                    ...
                    <!-- Supprimer -->
                    <form method="post" action="../../controllers/AbonnementController.php" style="display:inline" onsubmit="return confirm('Voulez-vous vraiment supprimer cet abonnement ?');">
